...
function BridalParty() {
  ...
  const bridesmaids = [
    ...
    { name: 'Samantha Ray', role: 'Childhood Friend & Neighbor', image: getProfileImage('sam', brideSideAvatar) },
    { name: 'Emily Cripe', role: 'Childhood Friend & Neighbor', image: getProfileImage('emily', brideSideAvatar) },
