      ...
      <div className="faqs-content">
        <div className="faq-item">
          ...
          <p className="faq-answer">
            Please plan to arrive by 1:30 PM EST to navigate Saint Mary's campus
            and be seated before the ceremony begins at 2:00 PM EST. Reference
            the available parking lots and take into consideration the walk and
            finding your way up to the 3rd floor of Le Mans Hall. Also, keep in
            mind South Bend is Eastern Time. For all you Chicago folks, that's a
        ...
        <div className="faq-item">
          ...
          <p className="faq-answer">
            ...
            <Link className="faq-inline-link" to="/attire">
              Attire page
            </Link>{" "}
          </p>
        </div>
        ...
        <div className="faq-item">
          ...
          <p className="faq-answer">
            Please refer to your invitation. Attendance is limited to the
            name(s) listed there, and guest substitutions are not available.
          </p>
        </div>
        ...
        <div className="faq-item">
          ...
          <p className="faq-answer">
            While we love your little ones, we kindly request an adults-only
            celebration.
          </p>
        </div>
        ...
        <div className="faq-item">
          ...
          <p className="faq-answer">
            ...
            <Link className="faq-inline-link" to="/registry">
              Registry page
            </Link>
            .
          </p>
        ...
        <div className="faq-item">
          ...
          <p className="faq-answer">
            ...
            response any time before June 1st on the{" "}
            <Link className="faq-inline-link" to="/rsvp">
              RSVP page
            </Link>
            .
          </p>
